...
# predict using azure ml deployed model
...
url = 'https://test-model-hnbss.eastus2.inference.ml.azure.com/score'
...
headers = {'Content-Type':'application/json', 'Authorization':('Bearer '+ api_key), 'azureml-model-deployment': 'first-model-1' }
